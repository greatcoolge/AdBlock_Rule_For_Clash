...
# 第五步：保存生成的MRS文件
# 定义输出文件路径
$outputPath = "$PSScriptRoot/adblock_reject.mrs"
# 将MRS内容写入文件，使用UTF8编码
$mrsContent | Out-File -FilePath $outputPath -Encoding utf8
